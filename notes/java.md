...
Bu konu başlığı da okunması faydalı olacaktır: [file:"web.md" - title:"submit request vs Ajax"](https://github.com/ysf0/notes/blob/master/notes/web.md#submit-request-vs-ajax)
...
# FacesServlet
JSF için frontcontroller'ın ismidir.
...
Uzak makinede yada aynı makinede farklı processler arasında metod çağırıp işletme mekanizmasıdır. bu bir consept'tir. protokol değildir. herkes uzaktaki bir metodu çağrıp dönüş alabilir. genelde programlama dilleri kendi protokollerini/standartlarını kullanıyor. bu sebeple cros-language değilledir.
