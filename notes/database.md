...
primary key + inremental + integer olan sutunlar otomatik olarak "clustered index" olarak ayarlanabilir.
...
Artık hem username hem de age sutununu where koşulunda bulunduğumuz sorgular hızlanacaktır.
