...
webpack runtime'da "module" isminde bir static objeyi variable olarak inject ediyor. import etmeden bu objeyi kullanabiliyoruz. hot reload olduğunda, instance'larımızı yeniden yaratabileceğimiz callback metodlarımızı tanımlayabiliyoruz. örnek:
...
Persone p = new Person();var a=9;var b=1;
```
...
```js
{
    ...
    mappings: "AAA0B,kBAAhBA,QAAOC,SACjBD,OAAOC,OAAO..." // base64 of orjinal code
}
```
...
en alttan ikinci satırda bir self-conitained sourcemap dosyası var. o satırı, base64'ten encode ederske elimize şu geçer:
