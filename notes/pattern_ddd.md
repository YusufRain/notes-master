...
- Application: bu kısım 'use case'leri içerir. örneğin stok kontrolü... bu kısımda business logic yoktur. Controller'larımızın gittikleri ilk servisler diyebiliriz.
